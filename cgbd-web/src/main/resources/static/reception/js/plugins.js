...
if (document.getElementById("email")) {
    document.getElementById("email").onblur = function () {
        if (/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2，3}){1，2})$/.test(this.value)) document.getElementById("commentform").getElementsByTagName("img")[0].src = "http://cn.gravatar.com/avatar/" + hex_md5(this.value) + "？d=mm&s=80"
    }
}
;
// Remove Spaces
